		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Obtención Datos",
									"targetURL": "#combecloudapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combecloudapp-display": {
								"semanticObject": "combecloudapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.becloud.app",
									"url": sap.ui.require.toUrl("com/becloud/app")
								}
							}
						}
					}
