		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Objetos SAPUI5",
									"targetURL": "#combecloudobjetos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combecloudobjetos-display": {
								"semanticObject": "combecloudobjetos",
								"action": "display",
								"description": "Objetos utilizables SAPUI5",
								"title": "Objetos SAPUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.becloud.objetos",
									"url": sap.ui.require.toUrl("com/becloud/objetos")
								}
							}
						}
					}
